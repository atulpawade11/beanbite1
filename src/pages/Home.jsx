                    ...
                    <div className="absolute inset-0 z-0">
                     ...
                     <div className="relative z-10 p-8 md:p-16 lg:p-20 md:w-2/3 lg:w-[55%] flex flex-col justify-center h-full pt-20 md:pt-20">
                        ...
                        <motion.button 
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="border border-[4px] border-[#414C00] bg-[#C5D92D] hover:bg-[#b0c41a] text-[#fff] pl-8 pr-2 py-2 rounded-full font-bold text-lg inline-flex items-center justify-between gap-4 transition-all w-max shadow-lg group"
                        >
